...
public class MD2BinMapper : BinMapper {
    ...
    public readonly int[] MazeWallZNegGrp = { 14, 19 };
    public readonly int[] MazeWallZPosGrp = { 1, 5 };
    public readonly int[] MazeWallXPosGrp = { 6, 13 };
    public readonly int[] MazeWallXNegGrp = { 20, 27 };

    /* Array of the largest number in each group and the resultant map to the group.
     * Mainly for convenience, see usage. */
    public readonly int[] MazeWallDivider = { 5, 13, 19, 27 };
    public readonly int[] MazeWallGrps = { MazeWallZPos, MazeWallXPos, MazeWallZNeg, MazeWallXNeg };
    ...
    public MD2BinMapper(int numOfBinsForFloorLength) {
